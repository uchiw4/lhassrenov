      ...
      <section className="bg-red-50 py-20">
        <div className="container mx-auto">
          ...
          <div className="flex justify-center mb-16">
            <Link href="/contact">
              <button className="bg-red-600 hover:bg-red-800 text-white font-medium px-6 py-3 rounded-lg shadow-md transition">
                Demandez un devis
              </button>
            </Link>
          </div>
            ...
            {values.map((value) => (
              <Card key={value.id} className="bg-gray-800 border-gray-700 p-6 shadow-xl">
                <div className="flex items-start">
                  <div className="flex-shrink-0 mr-4 text-red-400">{value.icon}</div>
                  <div>
